...
func JessicaP2R12DmgCalculate(calParams CalParams) []DamageResponse {
	...
	for i := 0; i < len(resonances); i++ {
		...
		poisonDamage := calculator.CalculateGenesisDamage(DamageCalculatorInfo{}, 0.3) * 18
		expectTotalDamage := skill2ExtraDamages[character.Star2] + skill1Extra2Damages[character.Star2] + ultimateI1Damages[character.Star1] + skill2ExtraDamages[character.Star2] + skill1Extra1Damages[character.Star2] + skill2ExtraDamages[character.Star2] + ultimateI1Damages[character.Star1] + skill1Extra2Damages[character.Star2] + skill2ExtraDamages[character.Star2] + ultimateI1Damages[character.Star1] + skill1Extra2Damages[character.Star2] + poisonDamage
	...
	for i := 0; i < len(resonances); i++ {
		...
		poisonDamage := calculator.CalculateGenesisDamage(DamageCalculatorInfo{}, 0.3) * 18
		expectTotalDamage := skill2ExtraDamages[character.Star2] + skill1Extra2Damages[character.Star2] + ultimateI1Damages[character.Star1] + skill2ExtraBuffDamages[character.Star2] + skill1Extra1Damages[character.Star2] + skill2ExtraDamages[character.Star2] + ultimateI1Damages[character.Star1] + skill1Extra2BuffDamages[character.Star2] + skill2ExtraDamages[character.Star2] + ultimateI1Damages[character.Star1] + skill1Extra2BuffDamages[character.Star2] + poisonDamage
