...
func JessicaP2R10DmgCalculate(calParams CalParams) []DamageResponse {
	...
	for i := 0; i < len(resonances); i++ {
		...
		expectTotalDamage := skill2ExtraDamages[character.Star2] + skill1Extra2Damages[character.Star2] + ultimateI1Damages[character.Star1] + skill2ExtraDamages[character.Star2] + skill1Extra1Damages[character.Star2] + skill2ExtraDamages[character.Star2] + ultimateI1Damages[character.Star1] + skill1Extra2Damages[character.Star2] + skill2ExtraDamages[character.Star2] + poisonDamages
