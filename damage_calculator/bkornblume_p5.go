...
func BkornblumeP5DmgCalculate(calParams CalParams) []DamageResponse {
	...
	character.BkornblumeP5.SetInsightLevel(character.Insight3L60)

	for i := 0; i < len(resonances); i++ {
		calculatorForBraveNewWorld := DamageCalculator{
			Character:         character.BkornblumeP5,
